...
// @Access  Public
exports.getCategory = AsyncHandler(async (_req , _res)=>{
...
// @Access  Privte
exports.updateCategory = AsyncHandler(async (_req , _res)=>{
    const {id} = _req.params;
...
// @Access  Privte
exports.deleteCategory = AsyncHandler(async (_req , _res)=>{
    const {id} = _req.params;
